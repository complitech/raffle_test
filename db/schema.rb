...
ActiveRecord::Schema.define(version: 2019_11_21_094650) do
  ...
  create_table "raffles", force: :cascade do |t|
    ...
    t.index ["name"], name: "index_raffles_on_name", unique: true
  end
  ...
  create_table "user_raffles", force: :cascade do |t|
    ...
    t.index ["user_id", "raffle_id"], name: "index_user_raffles_on_user_id_and_raffle_id", unique: true
